                    ...
                    >
                        ...
                        <div className="flex border-b border-blue-800">
                            <button
                                ...
                                className={`flex-1 py-3 text-center font-medium text-sm ${activeTab === 'videos' ? 'bg-blue-800/30 text-white' : 'text-blue-300 hover:bg-blue-800/20'
                                    }`}
                            >
                                Videos
                            </button>
                            <button
                                ...
                                className={`flex-1 py-3 text-center font-medium text-sm ${activeTab === 'quiz' ? 'bg-blue-800/30 text-white' : 'text-blue-300 hover:bg-blue-800/20'
                                    }`}
                            >
                                Course Quiz
                            </button>
                                ...
                                <div className="p-1">
                                    {course.videos.map((video, index) => (
                                        <motion.div
                                            ...
                                            className={`p-3 mb-1 rounded-lg cursor-pointer ${selectedVideo.id === video.id ? 'bg-blue-700/50' : 'hover:bg-blue-800/30'
